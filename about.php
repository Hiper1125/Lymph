...
<body class="animte-in">
    ...
    <div class="banner container">
        <h1 class="visitModuleTitle text-center mt-4">About</h1>

        <div class="visitModuleContent">
            <div class="row d-flex justify-content-center no-wrap">
                <p class="bannerDescript">Our treatment is at the forefront and allows a complete rehabilitation in full
